   ...
   */
    ...
    public static void main (String args[]) {
        ...
        do { // this is my do loop, also this contains my if statements
            ...
            } else if (n >= 2 && n <= 5 && n == (n / 2) * 2) {//  this tests if its between 2 and 5 and even
                System.out.println("your number is " + n);
                System.out.println("weird");
            } else if (n >= 6 && n <= 20 && n == (n / 2) * 2) {// this tests if it's between 6 and 20 and even
                System.out.println("your number is " + n);
                System.out.println("weird");
            } else if (n > 20 && n == (n / 2) * 2) {//  this tests if it's above 20 and even
                System.out.println("your number is " + n);
